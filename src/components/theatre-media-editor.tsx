    ...
    <div className="space-y-8">
      ...
      <div className="border-t border-border pt-6">
        <div className="grid gap-5 lg:grid-cols-2">
          <div className="overflow-hidden rounded-xl border border-border bg-background/50 p-4">
          ...
          <div className="overflow-hidden rounded-xl border border-border bg-background/50 p-4">
            ...
            {embedUrl ? (
              <div className="overflow-hidden rounded-lg border border-border">
                <iframe
                  src={embedUrl}
                  title={`${theatre.name} virtual tour preview`}
              ...
              <p className="rounded-lg border border-dashed border-border bg-background/40 p-8 text-center text-sm text-muted-foreground">
