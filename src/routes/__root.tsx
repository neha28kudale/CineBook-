  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-foreground">Reel not found</h2>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CineBook — Movie Tickets & F&B Pre-orders" },
      {
        name: "description",
        content:
          "Book movie tickets online, pick your seats on a live seat map, pre-order popcorn and drinks, pay securely and skip the queue with a digital ticket.",
      },
      { property: "og:title", content: "CineBook — Movie Tickets & F&B Pre-orders" },
      {
        property: "og:description",
        content:
          "Browse movies, pick seats, pre-order food & beverages, and get a digital ticket — no interval queues.",
      },
        ...
        <footer className="border-t border-border py-8">
          <div className="mx-auto flex max-w-6xl flex-col items-center gap-2 px-4 text-center">
            ...
            <p className="text-xs text-muted-foreground">
              Book seats, pre-order snacks, skip the queue. Enjoy the show.
            </p>
          </div>
        </footer>
      </div>
